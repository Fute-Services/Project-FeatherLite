  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="absolute bottom-24 left-1/2 xl:left-[20%] -translate-x-1/2 z-30 flex flex-col items-center gap-4 pointer-events-none w-full max-w-[96vw] xl:max-w-4xl"
      >
        {/* Top Row: Sub-nav */}
        <div className="flex flex-wrap items-center justify-center gap-2 xl:gap-4 pointer-events-auto w-full">
          {/* View/Hide Button */}
          <button
            onClick={onToggleView}
            className="flex items-center gap-2 xl:gap-3 px-4 xl:px-8 py-2 text-sm xl:text-base bg-[#FF0000] hover:bg-red-700 text-white rounded-full font-medium transition-colors shadow-lg active:scale-95"
          >
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 xl:gap-3 px-4 xl:px-8 py-2 text-sm xl:text-base bg-black/50 backdrop-blur-md border border-white/10 text-white rounded-full font-medium hover:bg-black/60 transition-colors shadow-lg"
            >
              <span>Levels</span>
          ...
          <button
            ...
            className="px-4 xl:px-8 py-2 text-sm xl:text-base bg-black/50 backdrop-blur-md border border-white/10 text-white rounded-full font-medium hover:bg-black/60 transition-all duration-300 shadow-lg whitespace-nowrap"
          >
            Virtual Tour
          </button>
